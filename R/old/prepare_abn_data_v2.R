...
setwd("/Users/hrobbins827/Documents/PhD/NCI overflow/NLST/Analysis/Nodule data")
...
lrads <- read.sas7bdat("/Users/hrobbins827/Documents/PhD/NCI overflow/NLST/Analysis/Nodule data/lungrads1.sas7bdat")
abn <- read.csv("/Users/hrobbins827/Documents/PhD/NCI overflow/NLST/Analysis/Nodule data/mortalityrisk_abn_080216.csv")
...
abn.pl <- abn %>% group_by(pid, STUDY_YR) %>%
  summarise(longest.diam = max(SCT_LONG_DIA, na.rm=T),
            ...
            any.other.att = as.numeric(any(SCT_PRE_ATT==7, na.rm=T)),
...
# Save to disk
save(abn.pl.all, file="/Users/hrobbins827/Documents/PhD/NCI overflow/NLST/Analysis/Nodule data/abn.spl.20160810.rdata")
