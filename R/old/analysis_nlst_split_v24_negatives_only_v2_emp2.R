...
source("H:/Lung/Hilary/hilary_functions.R")
source("kovalchik.R")
...
nlst.emp=read.csv("H:/Lung/Hilary/emp_pred.csv")
nlst.emp2=read.csv("H:/Lung/Hilary/emph_pred_nonoise.csv")
nlst.emp.comb=merge(nlst.emp, nlst.emp2)
rm(nlst.emp, nlst.emp2)
nlst.emp.comb$interval<-1
...
# RL: merge in new emphaseyma data
data.screen.abn.neg.emp<-merge(data.screen.abn.neg, nlst.emp.comb, by=c("pid","interval"))
data.screen.abn.negT0.emp<- filter(data.screen.abn.neg.emp, interval==1)
data.screen.abn.negT1.emp<-filter(data.screen.abn.neg.emp, interval==2)


data.interval.abn.emp<-merge(data.interval.abn, nlst.emp.comb, by=c("pid","interval"))
data.interval.abnT0.emp<- filter(data.interval.abn.emp, interval==1)

data.screen.abn.negT0.emp$weight<-ifelse(data.screen.abn.negT0.emp$case==1,1,20)
data.interval.abnT0.emp$weight<-ifelse(data.interval.abnT0.emp$case==1,1,20)
...
glm.screen.neg.abn <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:emphysema -1, data=data.screen.abn.neg, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.neg$post.risk.abn <- fitted.values(glm.screen.neg.abn)
glm.screen.neg.abn.sum<- summary(glm.screen.neg.abn)
coef(glm.screen.neg.abn.sum)
with(filter(data.screen.abn.neg), roc(case, post.risk.abn, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.interval.neg.abn <- glm(case ~ log1yrisk + log1yrisk:consolidation -1, data=data.interval.abn, family=binomial(link='log'), na.action=na.exclude)
data.interval.abn$post.risk.abn <- fitted.values(glm.interval.neg.abn)
glm.interval.neg.abn.sum<- summary(glm.interval.neg.abn)
coef(glm.interval.neg.abn.sum)
with(filter(data.interval.abn), roc(case, post.risk.abn, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2


glm.screen.neg.abn.emp <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:emphysema -1, data=data.screen.abn.neg.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.neg.emp$post.risk.abn <- fitted.values(glm.screen.neg.abn.emp)
# AIC: 862.8, residual deviance =856.8

glm.screen.neg.abn.emp1 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:score -1, data=data.screen.abn.neg.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.neg.emp$post.risk.abn.emp1 <- fitted.values(glm.screen.neg.abn.emp1)
#AIC: 862.7, residual deviance =856.7

glm.screen.neg.abn.emp2 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:score2 -1, data=data.screen.abn.neg.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.neg.emp$post.risk.abn.emp2 <- fitted.values(glm.screen.neg.abn.emp2)
#AIC: 862.8, residual deviance =856.8

### restricted to screen detected cancers at T1:
glm.screen.negT0.abn.emp <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:emphysema -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn <- fitted.values(glm.screen.negT0.abn.emp)
glm.screen.negT0.abn.emp.sum<- summary(glm.screen.negT0.abn.emp)
coef(glm.screen.negT0.abn.emp.sum)
# AIC: 761.9, residual deviance =755.9

# Interval cancer model
with(filter(data.screen.abn.negT0.emp, interval==1), roc(case, post.risk.abn, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2


glm.screen.negT0.abn.emp1 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:score -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.emp1 <- fitted.values(glm.screen.negT0.abn.emp1)
glm.screen.negT0.abn.emp1.sum<- summary(glm.screen.negT0.abn.emp1)
coef(glm.screen.negT0.abn.emp1.sum)

with(filter(data.screen.abn.negT0.emp, interval==1), roc(case, post.risk.abn.emp1, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.screen.negT0.abn.emp2 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:score2 -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.emp2 <- fitted.values(glm.screen.negT0.abn.emp2)
glm.screen.negT0.abn.emp2.sum<- summary(glm.screen.negT0.abn.emp2)
coef(glm.screen.negT0.abn.emp2.sum)

with(filter(data.screen.abn.negT0.emp, interval==1), roc(case, post.risk.abn.emp2, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2


### restrcited to interval cancers T0-T1
glm.int.abn.emp <- glm(case ~ log1yrisk + log1yrisk:adenop.consol -1, data=data.interval.abnT0.emp, family=binomial(link='log'))
data.interval.abnT0.emp$post.risk.abn <- fitted.values(glm.int.abn.emp)
glm.int.abn.emp.sum<- summary(glm.int.abn.emp)
coef(glm.int.abn.emp.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.int.abn.emp0 <- glm(case ~ log1yrisk + log1yrisk:adenop.consol + log1yrisk:emphysema -1, data=data.interval.abnT0.emp, family=binomial(link='log'))
data.interval.abnT0.emp$post.risk.abn0 <- fitted.values(glm.int.abn.emp0)
glm.int.abn.emp0.sum<- summary(glm.int.abn.emp0)
coef(glm.int.abn.emp0.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn0, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.int.abn.emp1 <- glm(case ~ log1yrisk + log1yrisk:adenop.consol + log1yrisk:score -1, data=data.interval.abnT0.emp, family=binomial(link='log'))
data.interval.abnT0.emp$post.risk.abn1 <- fitted.values(glm.int.abn.emp1)
glm.int.abn.emp1.sum<- summary(glm.int.abn.emp1)
coef(glm.int.abn.emp1.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn1, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.int.abn.emp2 <- glm(case ~ log1yrisk + log1yrisk:adenop.consol + log1yrisk:score2 -1, data=data.interval.abnT0.emp, family=binomial(link='log'))
data.interval.abnT0.emp$post.risk.abn2 <- fitted.values(glm.int.abn.emp2)
glm.int.abn.emp2.sum<- summary(glm.int.abn.emp2)
coef(glm.int.abn.emp2.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn2, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2
...
data.screen.abn.negT0.emp$score_min<-min(data.screen.abn.negT0.emp$score[data.screen.abn.negT0.emp$score>0])
data.screen.abn.negT0.emp$score_max<-max(data.screen.abn.negT0.emp$score[data.screen.abn.negT0.emp$score<1])
data.screen.abn.negT0.emp$score2_min<-min(data.screen.abn.negT0.emp$score2[data.screen.abn.negT0.emp$score2>0])
data.screen.abn.negT0.emp$score2_max<-max(data.screen.abn.negT0.emp$score2[data.screen.abn.negT0.emp$score2<1])



hist(data.screen.abn.negT0.emp$score,  main="original score")
hist(log(data.screen.abn.negT0.emp$score),  main="log(original score)")
hist(logit(data.screen.abn.negT0.emp$score), main="logit(original score)")
hist(data.screen.abn.negT0.emp$score2,  main="no-noise score")
hist(log(data.screen.abn.negT0.emp$score2),  main="log(no-noise score)")
hist(logit(data.screen.abn.negT0.emp$score2),  main="logit(no-noise score)")

data.screen.abn.negT0.emp$scoreb<-ifelse(data.screen.abn.negT0.emp$score==0,data.screen.abn.negT0.emp$score_min,ifelse(data.screen.abn.negT0.emp$score==1,data.screen.abn.negT0.emp$score_max,data.screen.abn.negT0.emp$score))
data.screen.abn.negT0.emp$score2b<-ifelse(data.screen.abn.negT0.emp$score2==0,data.screen.abn.negT0.emp$score2_min,ifelse(data.screen.abn.negT0.emp$score2==1,data.screen.abn.negT0.emp$score2_max,data.screen.abn.negT0.emp$score2))

data.screen.abn.negT0.emp$logscore<-log(data.screen.abn.negT0.emp$scoreb)
data.screen.abn.negT0.emp$logitscore<-logit(data.screen.abn.negT0.emp$scoreb)
data.screen.abn.negT0.emp$logscore2<-log(data.screen.abn.negT0.emp$score2b)
data.screen.abn.negT0.emp$logitscore2<-logit(data.screen.abn.negT0.emp$score2b)


### restricted to screen detected cancers at T1:
glm.screen.negT0.abn.logitemp1 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logitscore -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.logitemp1 <- fitted.values(glm.screen.negT0.abn.logitemp1)
glm.screen.negT0.abn.logitemp1.sum<- summary(glm.screen.negT0.abn.logitemp1)
coef(glm.screen.negT0.abn.logitemp1.sum)

with(filter(data.screen.abn.negT0.emp, interval==1), roc(case, post.risk.abn.logitemp1, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2


glm.screen.negT0.abn.logitemp2 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logitscore2 -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.logitemp2 <- fitted.values(glm.screen.negT0.abn.logitemp2)
glm.screen.negT0.abn.logitemp2.sum<- summary(glm.screen.negT0.abn.logitemp2)
coef(glm.screen.negT0.abn.logitemp2.sum)

with(filter(data.screen.abn.negT0.emp, interval==1), roc(case, post.risk.abn.logitemp2, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.screen.negT0.abn.logemp1 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logscore -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.logemp1 <- fitted.values(glm.screen.negT0.abn.logemp1)
glm.screen.negT0.abn.logemp1.sum<- summary(glm.screen.negT0.abn.logemp1)
coef(glm.screen.negT0.abn.logemp1.sum)

glm.screen.negT0.abn.logemp2 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logscore2 -1, data=data.screen.abn.negT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.screen.abn.negT0.emp$post.risk.abn.logemp2 <- fitted.values(glm.screen.negT0.abn.logemp2)
glm.screen.negT0.abn.logemp2.sum<- summary(glm.screen.negT0.abn.logemp2)
coef(glm.screen.negT0.abn.logemp2.sum)

### interval cancers
data.interval.abnT0.emp$score_min<-min(data.interval.abnT0.emp$score[data.interval.abnT0.emp$score>0])
data.interval.abnT0.emp$score_max<-max(data.interval.abnT0.emp$score[data.interval.abnT0.emp$score<1])
data.interval.abnT0.emp$score2_min<-min(data.interval.abnT0.emp$score2[data.interval.abnT0.emp$score2>0])
data.interval.abnT0.emp$score2_max<-max(data.interval.abnT0.emp$score2[data.interval.abnT0.emp$score2<1])


data.interval.abnT0.emp$scoreb<-ifelse(data.interval.abnT0.emp$score==0,data.interval.abnT0.emp$score_min,ifelse(data.interval.abnT0.emp$score==1,data.interval.abnT0.emp$score_max,data.interval.abnT0.emp$score))
data.interval.abnT0.emp$score2b<-ifelse(data.interval.abnT0.emp$score2==0,data.interval.abnT0.emp$score2_min,ifelse(data.interval.abnT0.emp$score2==1,data.interval.abnT0.emp$score2_max,data.interval.abnT0.emp$score2))

data.interval.abnT0.emp$logscore<-log(data.interval.abnT0.emp$scoreb)
data.interval.abnT0.emp$logitscore<-logit(data.interval.abnT0.emp$scoreb)
data.interval.abnT0.emp$logscore2<-log(data.interval.abnT0.emp$score2b)
data.interval.abnT0.emp$logitscore2<-logit(data.interval.abnT0.emp$score2b)

### restricted to interval cancers T0- T1:
glm.int.abn.logitemp1 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logitscore -1, data=data.interval.abnT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.interval.abnT0.emp$post.risk.abn.logitemp1 <- fitted.values(glm.int.abn.logitemp1)
glm.int.abn.logitemp1.sum<- summary(glm.int.abn.logitemp1)
coef(glm.int.abn.logitemp1.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn.logitemp1, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2

glm.int.abn.logitemp2 <- glm(case ~ log1yrisk + log1yrisk:consolidation + log1yrisk:logitscore2 -1, data=data.interval.abnT0.emp, family=binomial(link='log'), na.action=na.exclude)
data.interval.abnT0.emp$post.risk.abn.logitemp2 <- fitted.values(glm.int.abn.logitemp2)
glm.int.abn.logitemp2.sum<- summary(glm.int.abn.logitemp1)
coef(glm.int.abn.logitemp2.sum)

with(filter(data.interval.abnT0.emp, interval==1), roc(case, post.risk.abn.logitemp2, ci=T, plot=T))  # T0-T1 - change interval for T1-T2, post-T2
...
# ### RL
# int.psr.emp <- glm(case ~ log1yrisk+score+1, data=data.interval.abn, family=binomial(link='log'))
# summary(int.psr.emp)
...
png(file="screen_neg_interval_ad_con.png",width=1200,height=850)
ggplot() +
