...
Table 1: Demographics of CT scan recipients (familiar for epidemiologists)
...
Figure 2B: Network architecture: `training_graph.py` (helpful for those not familiar with deep learning)
...
Figure 3C: Confusion matrix - 2 x 2 table of actual versus predicted labels to show performance of Markov model
Figure 3D: Receiver operating characteristic (ROC) curve to show performance of Markov model

Figure 4: Comparison of binary classifier network versus image features network
