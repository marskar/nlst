...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"nlst","description":"An example of including non-code files in a package."}'
	test -f README.rst || echo "nlst" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/nlst.git
